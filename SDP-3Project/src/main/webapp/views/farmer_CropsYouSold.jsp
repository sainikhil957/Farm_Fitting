...
<body>
   ...
   <div class="p-1 mb-2  text-dark" style="text-align:center; background-color: deepskyblue; margin-top: 100px;"><h2>CROPS YOU SOLD</h2></div>
